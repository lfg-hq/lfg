...
;
;
async function generateVerificationToken(email, userId) {
    ...
    ;
    await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].verificationToken.create({
        data: {
            identifier: email,
            token,
            expires,
...
async function verifyToken(token) {
    const verificationToken = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].verificationToken.findUnique({
        where: {
            token
        },
        include: {
    ...
    if (verificationToken.expires < new Date()) {
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].verificationToken.delete({
            where: {
                token
            }
        });
...
async function POST(req) {
    try {
        ...
        const token = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$tokens$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["generateVerificationToken"])(email, user.id);
        // Send verification email
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$email$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sendVerificationEmail"])(email, token);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__b6ead0cd._.js.map