...
urlpatterns = [
    ...
    path('api/repositories/<int:repository_id>/branches/', views.get_repository_branches, name='get_repository_branches'),
    path('api/repositories/<int:repository_id>/update-branch/', views.update_repository_branch, name='update_repository_branch'),
